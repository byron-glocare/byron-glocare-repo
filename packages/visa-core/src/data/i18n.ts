...
export const VI: Record<string, string> = {
  ...
  "같은 대학 어학당에서 교육중": "Đang học tiếng tại chính trường này",
  "재정·서류 혜택": "Ưu đãi tài chính · giấy tờ",
  "다른 대학 어학당에서 교육중": "Đang học tiếng tại trường khác",
  "같은 대학 진학: 재정 요건 완화(대학 확인)": "Học tiếp cùng trường: điều kiện tài chính được nới lỏng (xác nhận với trường)",
  ...
  "지역·등급이 '전체'면 학교를 선택해야 조회할 수 있어요.": "Nếu khu vực·hạng là 'Tất cả' thì phải chọn trường để tra cứu.",
  ...
  "한국어 능력 (TOPIK)": "Năng lực tiếng Hàn (TOPIK)",
  "TOPIK(한국어능력시험) 성적.": "Điểm TOPIK (Kỳ thi năng lực tiếng Hàn).",
  "시험기관(TOPIK)": "Tổ chức khảo thí (TOPIK)",
  "한국어 능력 (KIIP 이수)": "Năng lực tiếng Hàn (hoàn thành KIIP)",
  "사회통합프로그램(KIIP) 이수로 한국어 능력 증빙.": "Chứng minh năng lực tiếng Hàn qua hoàn thành chương trình KIIP.",
  "법무부(사회통합정보망)": "Bộ Tư pháp (Socinet)",
  "한국어 능력 (세종학당 이수)": "Năng lực tiếng Hàn (hoàn thành Sejong)",
  "세종학당 한국어연수 이수로 증빙.": "Chứng minh qua hoàn thành khóa tiếng Hàn tại Học viện Sejong.",
  "세종학당": "Học viện Sejong",
  "현지 오프라인 과정만 인정(온라인 제외).": "Chỉ công nhận khóa offline tại địa phương (không tính online).",
  "어학연수 출석증명서": "Giấy chứng nhận điểm danh khóa học tiếng",
  "한국 어학당 재학 중 출석을 증명.": "Chứng minh việc điểm danh khi đang học tại trường tiếng Hàn Quốc.",
  "어학연수 성적증명서": "Bảng điểm khóa học tiếng",
  "한국 어학당 과정 성적을 증명.": "Chứng minh điểm khóa học tại trường tiếng Hàn Quốc.",
  "어학연수 수료증": "Giấy chứng nhận hoàn thành khóa học tiếng",
  "한국 어학당 과정 수료를 증명.": "Chứng minh việc hoàn thành khóa học tại trường tiếng Hàn Quốc.",
  "재학 중인 한국 어학당": "Trường tiếng Hàn Quốc đang theo học",
  "D-4(어학연수)에서 D-2(학위과정)로 국내 변경 시 어학당 이수 실적으로 제출.": "Nộp làm thành tích học tiếng khi chuyển từ D-4 (học tiếng) sang D-2 (chương trình học vị) trong nước.",
  ...
  "1일 ~ 10일": "1 ~ 10 ngày",
  "다양함": "Đa dạng",
  "신청일로부터 3개월 이내": "Trong vòng 3 tháng kể từ ngày nộp đơn",
  "신청일로부터 30일 이내": "Trong vòng 30 ngày kể từ ngày nộp đơn",
  "접수일로부터 30일 이내": "Trong vòng 30 ngày kể từ ngày tiếp nhận",
  "예치일로부터 최대 3일": "Tối đa 3 ngày kể từ ngày ký quỹ",
  "학교": "Nhà trường",
  "친필 서명": "Chữ ký tay",
