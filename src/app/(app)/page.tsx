...
const PHASES = [
  ...
  { num: 4, title: "교육원·요양원 CRUD", status: "done" },
  { num: 5, title: "고객관리 핵심", status: "done" },
  { num: 6, title: "정산 모듈", status: "done" },
  { num: 7, title: "알림발송", status: "done" },
  { num: 8, title: "설정", status: "done" },
  { num: 9, title: "대시보드 위젯", status: "in_progress" },
