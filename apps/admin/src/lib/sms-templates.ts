...
// =============================================================================
// 강의 정보 문의 — 같은 내용을 표현만 조금씩 바꾼 5종 중 랜덤 발송
// (매달 비슷한 문자가 반복되므로 기계 발송 느낌을 줄이기 위함)
// =============================================================================

export const CLASS_INQUIRY_MESSAGES: string[] = [
  "안녕하세요 원장님. 이번 달과 다음 달 강의 정보를 문의 드리고자 문자 드립니다. 주/야간 구분과 강의 시작일 확인 부탁드리겠습니다 :) 혹시 정확한 날짜가 나오지 않았다면 대략적인 날짜 옆에 (미정)으로 알려주시면 큰 도움이 될 것 같습니다. 좋은 하루 되세요!",
  "원장님 안녕하세요, 글로케어입니다. 이번 달과 다음 달 개강 일정이 궁금하여 연락드렸습니다. 주/야간 구분과 시작일을 알려주시면 감사하겠습니다 :) 아직 확정 전이라면 예상 날짜에 (미정)을 붙여서 보내주셔도 충분합니다. 늘 감사드립니다!",
  "안녕하세요 원장님, 글로케어입니다 :) 이번 달·다음 달 강의 일정 확인차 문자 드립니다. 주간/야간 구분과 개강일을 회신 부탁드려도 될까요? 날짜가 미확정이면 대략적인 일자 뒤에 (미정)으로 표기해 주시면 됩니다. 오늘도 좋은 하루 보내세요!",
  "원장님, 안녕하세요! 다름이 아니라 이번 달과 다음 달 강의 시작 일정을 여쭤보려고 연락드렸습니다. 주/야간 여부와 시작 날짜를 확인해 주시면 감사하겠습니다 :) 확정 전이시라면 예상일에 (미정) 표시로 알려주셔도 좋습니다. 감사합니다!",
