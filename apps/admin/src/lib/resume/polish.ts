...
기본적으로 학생 입력보다 50% 정도 길게 — 학생이 쓴 사실을 풀어서 자세히 설명.
단 없는 사실 창작 금지. 학생이 안 쓴 부분은 추상 미사여구로 메우지 말 것.

- 학생 입력 200자 미만 → 300~500자 정도 (학생이 쓴 사실 범위 안에서 풀어서).
- 학생 입력 200~800자 → 입력의 1.5배 (300~1200자).
- 학생 입력 800자 초과 → 입력의 1.5배, 최대 1800자.
