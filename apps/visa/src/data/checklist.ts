...
export const DOCS: ChecklistDoc[] = [
  ...
  { id: "visa-form", name: "비자 신청서", section: "신분·공통", courses: ["univ", "hagwon"], brief: "정해진 양식 작성.", holder: "본인", issuer: "본인 작성", form: "원본", signature: "친필 서명", detailDesc: "여권용 증명사진 3.5×4.5cm 1장 부착." },
  ...
  { id: "family-ct07", name: "가족관계 확인서(CT07)", section: "신분·공통", courses: ["univ", "hagwon"], brief: "가족관계 확인.", holder: "본인", issuer: "베트남 공안", form: "원본", signature: "친필 서명 원본만(전자·스캔·인쇄 불가)", translation: U, obtainDays: U, onlyVN: true },
  ...
  { id: "residence-ct08", name: "거주 확인서(CT08)", section: "신분·공통", courses: ["univ", "hagwon"], brief: "북부 출신이 호치민 총영사관에 접수할 때.", cond: "남부 1년 이상 거주 이력(대체: 남부 6개월 근무·재학). 남부 고교 졸업 6개월 이내면 면제.", holder: "본인", issuer: "베트남 공안", form: "원본", translation: U, obtainDays: U, onlyVN: true, onlyNorth: true },
