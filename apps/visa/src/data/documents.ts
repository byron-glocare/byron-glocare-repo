...
export const DOCUMENTS_DATA: VisaDoc[] = [
  ...
  },
  {
    ...
    appliesTo: "학력·성적 입증. 교환·방문학생은 본국 대학 성적표.",
    ruleRefs: ["PRC-012", "DOC-030"],
    confidence: "confirmed",
    sources: ["hcmc_cur"],
  },
  {
  ...
  /* ══════════ 대학·기관 (5) ══════════ */
  {
    ...
    ruleRefs: ["DOC-010", "ADM-010", "ADM-040"],
    confidence: "confirmed",
    sources: ["moe_standard_2025", "hcmc_cur"],
  },
  {
  ...
  /* ══════════ 재정 (20) — 준비 부담의 절반이 여기 몰림 ══════════ */
  {
    ...
    ruleRefs: ["FIN-030", "FIN-031", "FIN-032", "FIN-033", "FIN-040", "FIN-041", "FIN-042", "FIN-050", "FIN-051", "FIN-053", "FIN-054", "ADM-030"],
    confidence: "confirmed",
  ...
  /* ══════════ 어학 (4) ══════════ */
  {
    ...
    ruleRefs: ["LNG-020", "LNG-021", "LNG-022", "LNG-010", "LNG-011"],
    confidence: "confirmed",
    sources: ["hcmc_cur", "moe_standard_2025"],
  },
  {
