...
const koDict = {
  ...
  "login.or": "또는",
  "login.phone.label": "전화번호로 시작하기",
  "login.phone.ph": "010-1234-5678",
  "login.phone.send": "인증번호 받기",
  "login.phone.sending": "전송 중...",
  "login.phone.code_label": "인증번호",
  "login.phone.code_ph": "6자리 숫자",
  "login.phone.verify": "확인하고 시작하기",
  "login.phone.verifying": "확인 중...",
  "login.phone.sent": "인증번호를 문자로 보냈어요.",
  "login.phone.resend": "다시 받기",
  "login.phone.error": "인증에 실패했어요. 다시 시도해주세요.",
...
const viDict: DictShape = {
  ...
  "login.or": "hoặc",
  "login.phone.label": "Bắt đầu bằng số điện thoại",
  "login.phone.ph": "010-1234-5678",
  "login.phone.send": "Nhận mã xác thực",
  "login.phone.sending": "Đang gửi...",
  "login.phone.code_label": "Mã xác thực",
  "login.phone.code_ph": "6 chữ số",
  "login.phone.verify": "Xác nhận và bắt đầu",
  "login.phone.verifying": "Đang xác nhận...",
  "login.phone.sent": "Đã gửi mã xác thực qua tin nhắn.",
  "login.phone.resend": "Gửi lại",
  "login.phone.error": "Xác thực thất bại. Vui lòng thử lại.",
