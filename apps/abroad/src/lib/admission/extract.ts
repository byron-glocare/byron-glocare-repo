...
\`\`\`json
{
  "identity": {
    ...
    "program_type": "language_program | associate_2yr | bachelor_3yr_extension | bachelor_4yr",
    "term": "YYYY-(Spring|Fall|Summer|Winter|Year)",
    "admission_category": "string (한국어, 예: '순수외국인 특별전형')",
  ...
  "departments": [
    {
      ...
      "years": "1-6",
      "capacity": "number | 'unlimited' | string",
  ...
  "eligibility": {
    ...
    "korean_proficiency": {
      ...
      "alternative_paths": [
        { "type": "sejong_institute | kiip | university_internal_test | korean_education_center | health_science_degree | elder_care_career", ... }
      ],
